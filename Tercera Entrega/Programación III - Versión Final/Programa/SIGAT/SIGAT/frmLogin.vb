Public Class frmLogin
    ...
    Private Sub cmd_Ingresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_Ingresar.Click
        ...
        Else 'Si no estan los campos vacios, valido el usuario
            Conexion.conectarse(txt_Usuario.Text, txt_Contrasenia.Text) 'Conecto a la base de datos
            permisos(txt_Usuario.Text) 'Doy los permisos al usuario
            Me.Close()
        End If
    End Sub

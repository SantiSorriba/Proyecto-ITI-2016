Module Modificaciones
    ...
    Public id_usu As Integer 'Variable para guardar el id de usuario
    ...
    Public Sub modificarusuario(ByVal nombre As String, ByVal apellido As String, ByVal cedula1 As Integer, ByVal cedula2 As Integer, ByVal combo_usu As Integer, ByVal direccion As String, ByVal departamento As String, ByVal nombreusu As String)
        '-----Cambiar datos del usuario-----
        'Verificar el tipo de usuario
        Select Case combo_usu
            Case 0
                id_usu = 1
            Case 1
                id_usu = 2
            ...
            Case 3
                id_usu = 4
        End Select
        sql = "update usuarios set ci='" & cedula2 & "', id='" & id_usu & "', nombre='" & nombre & "', apellido='" & apellido & "', direccion='" & direccion & "', departamento='" & departamento & "', nombre_usu='" & nombreusu & "', nro_bps='" & 123456789 & "' where ci='" & cedula1 & "'"
        Try
            cn.Execute(sql)
            MsgBox("Datos Modificados.")
        Catch ex As Exception
